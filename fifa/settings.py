...
SECRET_KEY = 'p%mfz%+7t2s%i!sug7j=ze=_5h(se2w-z(byiq11u_pvn5mzxh'
...
CACHES = {
    'default': {
        ...
        'LOCATION': os.path.join(BASE_DIR, 'myteam/cache/'),
    }
}
...
# In if clause because heroku is messing with logs
